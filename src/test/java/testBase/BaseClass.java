...
public class BaseClass {
	 ...
	 public Properties p;
		   ...
		   // Loggers
		    	logger=LogManager.getLogger(this.getClass()); //log4j2 logger
		    	
		   // Accessing environment from property file
		    	
		    	if(p.getProperty("execute_env").equalsIgnoreCase("remote"))
		    	{
		    		//String hubURL="http://172.17.144.1:4444/wd/hub";
		   ...
		   // OS set
		    ...
		    // Browser
			    	   ...
			    	   default: System.out.println("No such browser Found");return;
			    	   }
   ...
   public String randomString()
	...
	{
		String rdmString=RandomStringUtils.randomAlphabetic(5);
		return rdmString;
	...
	{
		String rdmNum=RandomStringUtils.randomNumeric(10);
		return rdmNum;
